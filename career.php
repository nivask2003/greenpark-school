...
<head>
    ...
    <title>Career - Green Park International School</title>
...
<body>
    ...
    <main>
        <section class="career-form">
            <iframe aria-label='CAREER FORM' frameborder="0" style="height:2000px;width:99%;border:none;" src='https://forms.zohopublic.in/jayapriyagroupofinstitutions1/form/CAREERFORM/formperma/nt_1VNLae_be-irOu5QTw2FC6k9CGmBEEf8noPgvjaU' >
</iframe>
        </section>
    </main>
        <?=template_footer()?>
